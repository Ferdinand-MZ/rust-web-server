...
pub struct DogRequest {
    pub owner: String, // mengapa di dog owner merupakan objectId tetapi di sini String? karena dari client kita akan menerima string, nanti di konversi ke ObjectId
    pub name: Option<String>,
    pub age: Option<u8>,
    pub breed: Option<String>,
}
